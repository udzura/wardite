  ...
  module Evaluator
    ...
    def self.i32_eval_insn(runtime, frame, insn)
      ...
      when :i32_load8_s
        ...
        runtime.stack.push(I32.from_bytes(buf, size: 1, signed: true))
      ...
      when :i32_load8_u
        ...
        runtime.stack.push(I32.from_bytes(buf, size: 1, signed: false))
      ...
      when :i32_load16_s
        ...
        runtime.stack.push(I32.from_bytes(buf, size: 2, signed: true))
      ...
      when :i32_load16_u
        ...
        runtime.stack.push(I32.from_bytes(buf, size: 2, signed: false))
