...
module Wardite
  ...
  class Runtime
    ...
    # @rbs frame: Frame
    # @rbs insn: [Symbol, Array[operandItem], Integer?, Integer?]
    # @rbs return: void
    def eval_insn(frame, insn)
      code, operand, else_pos, end_pos = *insn
      runtime = self
      # unmached namespace...
      case code
      when :unreachable
  ...
  class Frame
    ...
    attr_accessor :body #: Array[[Symbol, Array[Wardite::operandItem], Integer?, Integer?]]
    ...
    # @rbs pc: Integer
    # @rbs sp: Integer
    # @rbs body: Array[[Symbol, Array[Wardite::operandItem], Integer?, Integer?]]
    # @rbs arity: Integer
